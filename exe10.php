...
<head>
    ...
    <title>Soma dos Positivos e Contagem dos Negativos</title>
...
<body>
        <div class="container">
        <h2>Digite 20 números</h2>
    <form>
        <label for="numero">Digite os números:</label>

        <?php
            for ($i = 1; $i <= 20; $i++) {
                echo "Número $i: <input type='number' name='num[]' class='input_number' required>";
            }
        ?>
