...
<head>
    ...
    <title>Pirâmide de palavras</title>
...
<body>
    <div class="container">
        <h2>Pirâmide de palavras</h2>
    <form>
        <label for="numero">Digite a palavra:</label>
        <input type="text" name="palavra" id="palavra" class="input_number" class="input_number" required>
