...
<body>
    ...
    <form>
        ...
        <label for="numero">Digite por quantas vezes quer multiplicar:</label>
        <input type="number" name="numero2" id="numero2" class="input_number" class="input_number" required>
