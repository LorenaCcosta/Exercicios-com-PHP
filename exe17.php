...
<head>
    ...
    <title>Estatísticas do Vetor</title>
...
<body>
    ...
    <?php
        if (isset($_GET["numeros"])) {
            ...
            $media = array_sum($numeros) / $total;

            echo "<h3>Resultados:</h3>";
            echo "Maior número: <strong>$maior</strong><br>";
            echo "Menor número: <strong>$menor</strong><br>";
            echo "Percentual de pares: <strong>" . number_format($percentualPares, 2, ',', '.') . "%</strong><br>";
            echo "Média dos elementos: <strong>" . number_format($media, 2, ',', '.') . "</strong>";
