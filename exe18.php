...
<head>
    ...
    <title>Diferença de Vetores</title>
...
<body>
    <div class="container">
        <h2>Números não comuns entre dois vetores</h2>
    <form>
         <h3>Vetor 1</h3>
            <?php
            for ($i = 1; $i <= 10; $i++) {
                echo "<label for='a$i'>A$i:</label>";
                echo "<input type='number' name='a[]' id='a$i' class='input_number' required>";
            }
            ?>
            <h3>Vetor 2</h3>
            <?php
            for ($i = 1; $i <= 10; $i++) {
                ...
                echo "<input type='number' name='b[]' id='b$i' 
                class='input_number' required>";
            }
            ?>
    ...
    <?php
        if (isset($_GET["a"]) && isset($_GET["b"])) {
            ...
            $naoComuns = array_merge(
                array_diff($vetorA, $vetorB),
                array_diff($vetorB, $vetorA)
            );

            echo "<h3>Resultado:</h3>";
            echo "Vetor A: [" . implode(", ", $vetorA) . "]<br>";
            echo "Vetor B: [" . implode(", ", $vetorB) . "]<br>";
